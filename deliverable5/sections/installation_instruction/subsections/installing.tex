...
After unzipping the archive to a folder \texttt{<dest>}, the game installation will be stored at \path{<dest>/Hyper-<release_version>} (the \textit{game installation folder}).
